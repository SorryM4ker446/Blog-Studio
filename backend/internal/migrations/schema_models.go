// Frozen model definitions for establish_application_schema. Later migrations must not change these tables implicitly.
package migrations
...
type schemaPost struct {
	...
	Category     *schemaCategory `gorm:"foreignKey:CategoryID;constraint:OnUpdate:CASCADE,OnDelete:SET NULL" json:"category"`
...
type schemaFile struct {
	...
	DisplayName string    `gorm:"not null;size:255;default:''" json:"display_name"`
	Description string    `gorm:"not null;size:500;default:''" json:"description"`
...
func (schemaCategory) TableName() string { return "categories" }

func (schemaPost) TableName() string { return "posts" }

func (schemaFile) TableName() string { return "files" }

func (schemaSetting) TableName() string { return "settings" }
