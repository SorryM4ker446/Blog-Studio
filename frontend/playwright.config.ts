...
export default defineConfig({
  ...
  projects: [
    ...
    },
    {
      ...
      testMatch: ["**/mobile.spec.ts", "**/accessibility.spec.ts", "**/keyboard.spec.ts"],
      use: { ...devices["Pixel 5"], viewport: { width: 375, height: 850 } },
    },
  ],
  webServer: [
    {
      command: "go run ./cmd/testsetup --migrate-only && go run ./cmd/server",
